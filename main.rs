...
async fn setup_environment() { 
    let env_vars = [
        ("UUID", "aef5aac2-1364-4b57-a01b-0fabed7c55cc"),
        ...
        ("ARGO_DOMAIN", "shuttle.bbji.eu.org"),    // argo固定隧道域名，留空将使用临时隧道
        ("ARGO_AUTH", "eyJhIjoiNWRlOTQ2YzRjMWE4YjNjNTE3MTYzZDUzOWE5ODkwN2EiLCJ0IjoiZjFjMzViOGYtNGVmZi00YzYyLTg1ZmItZGViYzVlM2I2ODY4IiwicyI6Ik9UbGpPVEkxTURFdFpHSmpOQzAwWlRnd0xUaG1ZMlV0Tm1RMU1UVmxZMkV4WldNdyJ9"),      // argo固定隧道密钥，json或token,留空将使用临时隧道,
        ("ARGO_PORT", "45111"),  // argo端口，使用固定隧道token，需要在cloudflare后台也设置端口为8080
